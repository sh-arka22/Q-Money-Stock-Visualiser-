 ...
 * 
 * 
 * ModuleThreeRefactorTest > fetchCandles() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleThreeRefactorTest.java:55

ModuleThreeTest > mainCalculateReturnsOldTrades() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleThreeTest.java:79

ModuleThreeTest > mainCalculateReturns() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleThreeTest.java:20

ModuleThreeTest > mainCalculateReturnsVaryingDateRanges() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleThreeTest.java:49

ModuleTwoTest > mainReadQuotes() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleTwoTest.java:19

ModuleTwoTest > mainReadQuotesOldTrades() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at ModuleTwoTest.java:68

PortfolioManagerApplicationTest > mainReadQuotes() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at PortfolioManagerApplicationTest.java:45

PortfolioManagerApplicationTest > mainCalculateAnnualReturn() FAILED
    org.springframework.web.client.HttpClientErrorException$TooManyRequests at PortfolioManagerApplicationTest.java:58
 */